...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route("admin.index")}}" class="brand-link">
      <img src="{{asset("img")}}/favicon.png" alt="Cygne Bleu" class="brand-image img-circle elevation-3" style="opacity: 1;background-color:#fff">
      <span class="brand-text font-weight-light">Cygne Bleu</span>
    </a>
          ...
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="{{route('BilletReservation.index')}}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Billet</p>
                    </a>
                  </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="{{route('index')}}">Cygne Bleu</a>.</strong> All rights reserved.
  </footer>

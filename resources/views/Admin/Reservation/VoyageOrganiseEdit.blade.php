                ...
                <form action="{{route("VoyageOrganiseReservation.update",['VoyageOrganiseReservation'=>$voyageOrganiseReservation->id])}}" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-11">
                                <div class="form-group">
                                    <label for="Total">Mode paiement</label>
                                    <select name="paiement_type" class="form-control" id="">
                                    <option value="0" @if($voyageOrganiseReservation->paiement_type=="0") selected @endif>
                                        payer en Espèce
                                    </option>
                                    <option value="1" @if($voyageOrganiseReservation->paiement_type=="1") selected @endif>
                                        CCP / BaridiMob
                                    </option>
                                    <option value="2" @if($voyageOrganiseReservation->paiement_type=="2") selected @endif>
                                        Banque
                                    </option>
                                </select>
                                </div>
                            ...
                            <div class="col-md-1" style="align-self: center;">
                                 <a target="_blank"  type="button" data-toggle="modal" data-target="#myModal" style="font-size: 26px;" >
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-body">
            <img src="{{asset($voyageOrganiseReservation->paiment_photo)}}" class="img-responsive" >
        </div>
    </div>
  </div>
</div>

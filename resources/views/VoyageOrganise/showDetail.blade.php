        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-9">
                ...
                <div class="contact_join">
                    ...
                    <form action="{{route("VoyageOrganiseReservationController.store")}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="single_input">
                                    <select name="nb_Adolescente" id="nb_Adolescente">
                            ...
                            <div class="col-lg-4">
                                <div class="single_input">
                                   <input type="file"  id="paiment_photo" name="paiment_photo" disabled=""> 
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="single_input">
...
@section('script')
<script>
    $(document).on("change","#nb_Adulte,#nb_Adolescente,#nb_Enfant",function(){
        calculerTotal();
    })
    function calculerTotal(){

        var total=$("#nb_Adulte").val()*{{$voyageOrganise->prixAdulte}}+ $("#nb_Adolescente").val()*{{$voyageOrganise->prixAdolescente}} +$("#nb_Enfant").val()*{{$voyageOrganise->prixEnfant}};
       $("#total").val("Total : "+total+" DZ")
    }
    calculerTotal()
</script>
@endsection
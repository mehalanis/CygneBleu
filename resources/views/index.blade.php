...
@section('head')
 <style>
    ...
    @keyframes example {
        ...
        25%  { left: 550px; top:-100px;}
        50%  { left: 550px; top:50px;}
...
@section('content')
    ...
    <div class="slider_area">
        <div class="slider_active owl-carousel">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
                                <img src="{{asset('img')}}/logo_grande.png" alt=""  id='logo'>
            ...
            <div class="single_slider  d-flex align-items-center slider_bg_1 overlay" style="background-image: url('{{ asset("OBJECTS.png") }}')">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
                ...
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-12">
                                <div class="search_wrap">
                                    <form class="search_form" action="{{route("BilletController.Billet",['id'=>-1])}}" method="get">
                                        @csrf
                                        <div class="input_field input_field_billet">
                                            <select  id='ville_from_avion' name="ville_from" onchange="GetVilleArriveeJson(this.value)">
                                                <option data-display="From ?" value="0">From ?</option>
                                                @foreach ($ville_depart_avion as $item)
                                                        <option value="{{$item->id}}">{{$item->nom}} - {{ $item->pays->nom }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="input_field input_field_billet">
                                            <select  id='ville_to_avion' name="ville_to" >
                                        ...
                                        <div class="search_btn">
                                            <button class="boxed-btn4 " type="submit" >Recherche</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                ...
                @foreach ($billet as  $item)
                    <div class="col-lg-4 col-md-6">
                        <div class="single_destination">
                            ...
                            <div class="content">
                                <p class="d-flex align-items-center">{{$item->villeArriveeId->nom}}
                                    <a href="{{route("BilletController.Billet",['id'=>$item->id])}}">
                                        à partir de
                                        {{number_format($item->BilletDate()->selectRaw("min(prix) as minPrix")->get()[0]->minPrix,0," .",",")}}  DZ
                                    </a>
                                </p>
                            </div>
                        </div>
...
<script>
    ...
    var url_GetVilleArriveeJson="{{ route("GetVilleArriveeJson") }}";
    $(function(){
